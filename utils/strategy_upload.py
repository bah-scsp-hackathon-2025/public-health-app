...
class StrategyUploader:
    ...
    def __init__(self, api_key: Optional[str] = None):
        ...
        self.api_key = (
            api_key or 
            (settings.anthropic_api_key if settings and settings.anthropic_api_key else None) or
            ...
            if hasattr(files_response, 'data') and files_response.data:
                ...
                if strategy_only:
                    ...
                    for file_obj in files_response.data:
                        ...
                        if any(pattern in filename.lower() for pattern in ['strategy', 'paho', 'who', 'epidemic', 'outbreak', 'preparedness', 'response']):
